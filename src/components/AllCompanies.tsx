...
import { faCalendarAlt, faCalendarCheck, faListAlt, faSchool, faSchoolCircleCheck } from "@fortawesome/free-solid-svg-icons";
...
const CompanyList = (props: { token: string}) => {
  ...
  return (
    <><h1 className='text-center'><FontAwesomeIcon icon={faListAlt} /> All Companies</h1><br/>
