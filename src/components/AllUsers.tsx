import {faCalendarAlt, faList, faQuestionCircle, faUser, faUserAlt, faUserCircle, faUserCog} from '@fortawesome/free-solid-svg-icons';
                  ...
                  <Card className="text-center mb-3" key={user.id} bg="dark" border="secondary" text="light">
                    ...
                    <Card.Body>
                      <div>
                        ...
                        <ListGroupItem>
                          <Card.Text>
                            <FontAwesomeIcon icon={faUserCog} /> <b>Is superuser:</b> {user.is_superuser.toString()}
                          </Card.Text>
                        </ListGroupItem>
                        <ListGroupItem>
                          <Card.Text>
                        ...
                        <ListGroupItem>
                          <Card.Text>
                            ...
                            {moment(user.date_joined).format('Do MMMM YYYY')}
                          </Card.Text>
                        </ListGroupItem>
                      </div>
                      <Link
